---
title: 認証機能の実装Ⅳ
description: ユーザー編集機能
category: express
createdAt: 2023-03-05
updatedAt: 2023-03-05
sortNumber: 007
path: "/articles/express/007_passport_edit"
---

<nuxt-content-wrapper>

- [1. はじめに](#1-はじめに)
- [2. ユーザー情報の編集](#2-ユーザー情報の編集)
- [3. おわりに](#3-おわりに)
...
# 3. おわりに
ユーザー情報の更新をしたらトークンも更新しなければならないから、ログイン機能とユーザー登録機能を実装した時のナレッジを使う必要があるなと思った。ただ処理の流れはユーザー登録機能の時と大きく変わりはない。
